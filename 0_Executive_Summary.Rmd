...
fleet north of Point Conception. Because Stock Synthesis is
not set up to handle depth-dependent discard mortality rates and this model includes
two species as a complex with differing depth-dependent discard mortality rates,
the time series of commercial discards was incorporated as a separate fleet.
...
updated maturity curve, a number of new indicies, and new conditional length at age data.  
...
increase from 1996 to 2005. From 2005-2018 the stock has been in delcine, although spawning 
biomass has been relatively level since 2017. The 2018 estimated spawning biomass relative to unfished 
equilibrium spawning biomass is above the target of 40% of unfished spawning biomass at 45.01
(95% asymptotic interval: 30.78-59.24) (Figure \ref{fig:RelDeplete_all}). 
...
1990s, and also from 2014-2016, which peaked in 2015. 
...
(corresponding to a relative fishing intensity of 100%) (Table \ref{tab:SPR_Exploit_mod1} and 
 ...
 with no fishing. Harvest rates estimated by the base model exceeded management target levels 
 during a number of years in the 1990s. Recent harvest over the last decade increased until 
 2016-2017 peaking at 0.71, then declined to 0.66 in 2018.  The estimated relative depletion 
...
0.46 (95% asymptotic interval: 0.308-0.592, corresponding 
...
Gopher and black-and-yellow rockfishes are managed as part of the minor nearshore complex in 
the Pacific Coast Groundfish Fishery Management Plan.  The total mortality of the minor nearshore rockfish has been 
