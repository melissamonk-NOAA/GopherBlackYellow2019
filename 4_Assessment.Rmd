...
have never fallen to low enough levels that to estimate steepness. Steepness was 
not estimated in this model, and profiles over steepness values are discussed below.
