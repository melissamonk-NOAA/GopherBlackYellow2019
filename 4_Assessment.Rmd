...
Stock Reduction Analysis (DB-SRA) [@Dick2010]. The DB-SRA model assigned a 
...
was 0.2488, whereas the internal estimate was much lower at 0.125. Using the Schnute 
...
due to the shallower maximum depth fished to reduce barotrauma.  Dome shaped 
...
fixed to an external estimate is discussed below.
