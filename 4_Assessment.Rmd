...
length selectivity set to 1.0 for all sizes, and an age selectivity set to 1.0 at 
...
survey component minimized at the upper bound, with the remaining survey component minimized at the 
