...
each fishing stop. Once the onboard observer program ramped up by the mid-2000s, almost all of the 
CPFV groundfish trips sampled as onboard observer trips were also sampled as angler interviews. 
Using both the onboard observer data and the dockside interviews for this 
...
while hte remaining components minimize at the lower bound.  The age composition by fleet also 
has conflicting trends with the dummy fleet minimizeing just lower than the over all around 0.17, the
...
survey comonent minimized at the upper bround, with the remaining survey component minimized at the 
