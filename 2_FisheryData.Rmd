...
both speices well-represented in the catches. There is not way to tease apart the 
historical catches by species and even across north and south of Pt. Conception prior 
to about 1995.  This precludes the ability to model the catch histories for eiether species 
accurately. Given these constraints, all commercial dats were combined to represent one 
one commercial flee in the assessment.
...
the raw lenght composition data (Table \ref{tab:length_samples_fishery}). The 2005 assessment used commercial length composition 
informtion from CALCOM, but did not include black-and-yellow rockfish and is not directly
...
a linear ramp from from 1928-1936 that was not altered in this assessment.  From 1937-1979 linear ramp 
...
for the California Catch Recontruction and MRFSS time series.
...
recreational recontruction.  Recreational removals from the California Department 
...
(2004-2018) databases. The CRFS era removals account for depth-stratified 
discard mortality rate and the catch time series includes both retained and 
discarded catch (toal mortality).  We calculated the ratio of dead discards to 
...
added 4.68% annually to recreational removals north of Pt. Conception and 4.05%  annutally 
...
Pt. Conception) unsexed measurement of retained fish (no discards, ) were included in the assessment 
(Table ). Sampling of these length data did not follow consistent protocol over time and 
...
onboard observer program of thee CPFV fleet from 1985-1987 in southern California.  Becuase 
...
(Table \ref{tab:length_sample_fishery}). The length measurements from
...
The number of trips used as initial sample sizes for the MRFSS was based on....

During the recent restructiong of the CRFS data on RecFIN, a "trip" identifier was not 
...
using Ian Stewart's method (described above). All lenght data were re-weighted in the assessment model. 
