...
(in this case 0.4) at which the rate of "false positives" equals "false negatives."
...
of encountering a California scorpionfish.  This assumes that if GBYR were caught, the 
vessel must have fished in appropriate habitat during the trip. 

Catch per angler hour (CPUE; number of fish per angler hour) was modelled using a negative binomial model. Model selection using Akaike Information Criterion 
(AIC) supported inclusion of year and
