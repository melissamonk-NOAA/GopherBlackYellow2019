...
both species well-represented in the catches. There is not way to tease apart the 
...
accurately. Given these constraints, all commercial data were combined to represent one 
...
discarded catch (tonal mortality).  We calculated the ratio of dead discards to 
...
Pt. Conception) unsexed measurement of retained fish (no discards, ) were included in 
the assessment (Table \ref{tab:length_samples_fishery}). Sampling of these length
data did not follow consistent protocol over time and 
...
onboard observer program of thee CPFV fleet from 1985-1987 in southern California.  Because 
